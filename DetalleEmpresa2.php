...
<body>
    ...
    ?>
        ...
        <section class="servicios">
            <?php
            $servicios = mysqli_query($conexion, "SELECT * FROM servicio WHERE EMPRESA_idEmpresa ='$nik'");


            while ($rowServ = mysqli_fetch_array($servicios)) {
                $nombre = $rowServ["nombre_servicio"];
                $precio = $rowServ["precio_servicio"];
                $descripcion = $rowServ["descripcion"];

            ?>
                <div class="detail-servicios">

                    <p class="nombre"><label>Nombre: </label><?php echo $nombre; ?></p>
                    <p class="precio"><label>Precio: </label>$<?php echo $precio; ?></p>
                    <p class="descripcion"><label>Descripcion: </label><?php echo $descripcion; ?></p>
