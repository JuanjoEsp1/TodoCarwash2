...
$correo             = trim($_REQUEST['correo_empresa']); //Quitamos algun espacion en blanco
$consulta           = ("SELECT * FROM empresa WHERE correo_empresa ='".$correo."'");
...
$updateClave    = ("UPDATE empresa SET contrasena='$clave' WHERE correo_empresa ='".$correo."' ");
$queryResult    = mysqli_query($conexion,$updateClave); 

$destinatario = $correo; 
$asunto       = "Recuperando Clave - TodoCarwash";
$cuerpo = '
    <!DOCTYPE html>
    <html lang="es">
    <head>
    <title>Recuperar Clave de Empresa</title>';
$cuerpo .= ' 
<style>
    * {
        margin: 0;
